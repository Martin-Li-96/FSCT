...
other_parameters = dict(
    model_filename="best_modelv2.pth",
    ...
    min_points_per_box=1000,  # Minimum number of points for input to the model_mix_6_3_500. Too few points and it becomes near impossible to accurately label them (though assuming vegetation class is the safest bet here).
