...
if __name__ == "__main__":
    ...
    point_clouds_to_process=("/FSCT/data/ALICE_2021_raycloud_10_01.las",)
    for point_cloud_filename in point_clouds_to_process:
        parameters = dict(
            ...
            batch_size=25,  # You will get CUDA errors if this is too high, as you will run out of VRAM. This won't be an issue if running on CPU only. Must be >= 2.
